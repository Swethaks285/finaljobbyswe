...
class Jobs extends Component {
  ...
  getJobs = async () => {
    ...
    const apiUrl = `https://apis.ccbp.in/jobs?employment_type=${employeeTypeList.join()}&minimum_package=${minimumSalary}&location=${locationselect}&search=${searchInput}`
        ...
        <div className="jobs-container">
          <div className="jobs-content">
            <FiltersGroup
              ...
              locationselect={this.locationChange}
            />
